...
function drawBarrier(parent: GameObj) {
  const k = parent.k
  // Main red block - jump over
  parent.add([k.rect(60, 50), k.pos(-30, -25), k.color(...COLORS.BARRIER_RED)])
  // Dark outline
  parent.add([k.rect(64, 54), k.pos(-32, -27), k.color(...COLORS.BARRIER_DARK), k.z(-1)])
  // Warning stripes (yellow/black)
  parent.add([k.rect(60, 8), k.pos(-30, -25), k.color(...COLORS.WARNING_YELLOW)])
  parent.add([k.rect(12, 8), k.pos(-18, -25), k.color(...COLORS.WARNING_BLACK)])
  parent.add([k.rect(12, 8), k.pos(6, -25), k.color(...COLORS.WARNING_BLACK)])
  // Top edge highlight
  parent.add([k.rect(60, 4), k.pos(-30, 21), k.color(...COLORS.BARRIER_DARK)])
}

function drawLowBeam(parent: GameObj) {
  const k = parent.k
  // Low dark beam - slide under
  parent.add([k.rect(66, 20), k.pos(-33, -38), k.color(...COLORS.BEAM_GRAY)])
  // Dark outline
  parent.add([k.rect(70, 24), k.pos(-35, -40), k.color(...COLORS.BEAM_DARK), k.z(-1)])
  // Caution marks
  parent.add([k.rect(8, 16), k.pos(-28, -36), k.color(...COLORS.WARNING_YELLOW)])
  parent.add([k.rect(8, 16), k.pos(20, -36), k.color(...COLORS.WARNING_YELLOW)])
  // Support posts
  parent.add([k.rect(6, 30), k.pos(-30, -18), k.color(...COLORS.BEAM_DARK)])
  parent.add([k.rect(6, 30), k.pos(24, -18), k.color(...COLORS.BEAM_DARK)])
}

function drawPillar(parent: GameObj) {
  const k = parent.k
  // Tall red column - switch lanes
  parent.add([k.rect(40, 70), k.pos(-20, -35), k.color(...COLORS.PILLAR_RED)])
  // Dark outline
  parent.add([k.rect(44, 74), k.pos(-22, -37), k.color(...COLORS.BARRIER_DARK), k.z(-1)])
  // Warning stripe at top and bottom
  parent.add([k.rect(40, 8), k.pos(-20, -35), k.color(...COLORS.WARNING_YELLOW)])
  parent.add([k.rect(8, 8), k.pos(-12, -35), k.color(...COLORS.WARNING_BLACK)])
  parent.add([k.rect(8, 8), k.pos(4, -35), k.color(...COLORS.WARNING_BLACK)])
  parent.add([k.rect(40, 8), k.pos(-20, 27), k.color(...COLORS.WARNING_YELLOW)])
  parent.add([k.rect(8, 8), k.pos(-12, 27), k.color(...COLORS.WARNING_BLACK)])
  parent.add([k.rect(8, 8), k.pos(4, 27), k.color(...COLORS.WARNING_BLACK)])
}
